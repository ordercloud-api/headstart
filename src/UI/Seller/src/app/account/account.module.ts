...
import { MonitoredProductNotificationComponent } from './components/notifications/monitored-product-notifications/monitored-product-notification.component'
...
@NgModule({
  ...
  declarations: [
    ...
    MonitoredProductNotificationComponent,
  ],
})
