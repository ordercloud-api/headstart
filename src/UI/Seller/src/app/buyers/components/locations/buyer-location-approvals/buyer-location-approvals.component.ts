...
export class BuyerLocationApprovals {
    ...
    buildApprovalForm(approval?: ApprovalRule): void {
        ...
        this.approvalForm = new FormGroup({
            ...
            OrderThreshold: new FormControl(this.getOrderThreshold(approval?.RuleExpression))
        })
    }
    ...
    checkForChanges(): void {
        ...
        if(this.approvalEnabled !== hadApproval) {
            ...
            if(this.approvalEnabled && hadApproval) {
                this.areChanges = parseFloat(form.OrderThreshold) === this._initialThreshold ? false : true
            } else {
