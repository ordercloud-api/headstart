...
namespace exchangerates.tests
{
    public class ExchangeConversionTests
    {
        ...
        //public void Setup()
        //{
        //    mockBlob = Substitute.For<BlobServiceConfig>();
    ...
    //    private IExchangeRatesCommand _command;
    //    private BlobServiceConfig _config;
    ...
    //        _config = Substitute.For<BlobServiceConfig>();
    //        _simpleCache = Substitute.For<ISimpleCache>();
    //        _command = new ExchangeRatesCommand(_config, new PerBaseUrlFlurlClientFactory(), _simpleCache);
    //    }
    ...
    //        var _blob = Substitute.For<IOrderCloudIntegrationsBlobService>();
