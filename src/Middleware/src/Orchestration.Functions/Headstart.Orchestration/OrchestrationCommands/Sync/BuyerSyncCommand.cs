...
namespace Headstart.Orchestration
{
    public class BuyerSyncCommand : SyncCommand, IWorkItemCommand
    {
        ...
        public BuyerSyncCommand(AppSettings settings, LogQuery log, IOrderCloudClient oc) : base(settings, oc, log)
        {
            _oc = oc;
        }
        ...
        {
            var obj = wi.Current.ToObject<HSBuyer>();
            try
            {
                obj.ID = wi.RecordId;
        ...
        {
            var obj = wi.Current.ToObject<HSBuyer>(OrchestrationSerializer.Serializer);
            try
            {
        ...
        {
            var obj = wi.Diff.ToObject<PartialBuyer>(OrchestrationSerializer.Serializer);
            try
            {
