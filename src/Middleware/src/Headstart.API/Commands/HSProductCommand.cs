...
namespace Headstart.API.Commands.Crud
{
	...
	public class HSProductCommand : IHSProductCommand
	{
		...
		/// <returns>The HSPriceSchedule object from the GetPricingOverride process</returns>
		...
		/// <param name="token"></param>
		/// <returns>The HSPriceSchedule object from the CreatePricingOverride process</returns>
		...
		/// <param name="priceSchedule"></param>
		/// <param name="token"></param>
		/// <returns>The HSPriceSchedule object from the UpdatePricingOverride process</returns>
		...
		/// <param name="id"></param>
		/// <param name="token"></param>
		/// <returns>The SuperHSProduct object from the Get SuperHSProduct process</returns>
		...
		/// <summary>
		/// Public re-usable get a list of ListPage of SuperHSProduct objects task method
		/// </summary>
		...
		/// <returns>The SuperHSProduct object from the SaveAsync processes</returns>
		...
		/// <param name="superProduct"></param>
		/// <param name="token"></param>
		/// <returns>The SuperHSProduct object from the Products.SaveAsync process</returns>
		...
		/// <param name="decodedToken"></param>
		/// <returns>The Product object from the FilterOptionOverride process</returns>
		...
		/// <param name="token"></param>
		/// <returns>The PriceSchedule object from the UpdateRelatedPriceSchedules process</returns>
		...
		/// <returns>The list of the SpecOption objects from the ChangedSpecOptions process</returns>
