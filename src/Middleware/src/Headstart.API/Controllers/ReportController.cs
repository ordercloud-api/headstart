...
namespace Headstart.Common.Controllers
{
    ...
    public class ReportController : CatalystController
    {
        ...
        [HttpGet, Route("fetchAllReportTypes"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        public ListPage<ReportTypeResource> FetchAllReportTypes()
        {
            return reportCommand.FetchAllReportTypes(UserContext);
        }

        [HttpGet, Route("BuyerLocation/preview/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("BuyerLocation/download/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpGet, Route("ProductDetail/preview/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("ProductDetail/download/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpGet, Route("SalesOrderDetail/preview/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("SalesOrderDetail/download/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpGet, Route("PurchaseOrderDetail/preview/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("PurchaseOrderDetail/download/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpGet, Route("LineItemDetail/preview/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("LineItemDetail/download/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("ShipmentDetail/download/{templateID}"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpGet, Route("{reportType}/listtemplates"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpPost, Route("{reportType}"), OrderCloudUserAuth(nameof(ApiRole.AdminUserAdmin), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpGet, Route("{id}"), OrderCloudUserAuth(nameof(ApiRole.AdminUserAdmin), nameof(CustomRole.HSReportAdmin))]
        public async Task<ReportTemplate> GetReportTemplate(string id)
        {
            return await reportCommand.GetReportTemplate(id, UserContext);
        }

        [HttpPut, Route("{id}"), OrderCloudUserAuth(nameof(ApiRole.AdminUserAdmin), nameof(CustomRole.HSReportAdmin))]
        ...
        [HttpDelete, Route("{id}"), OrderCloudUserAuth(nameof(ApiRole.AdminUserAdmin), nameof(CustomRole.HSReportAdmin))]
        public async Task DeleteReportTemplate(string id)
        {
            await reportCommand.DeleteReportTemplate(id);
        }

        [HttpGet, Route("filters/buyers"), OrderCloudUserAuth(nameof(CustomRole.HSReportReader), nameof(CustomRole.HSReportAdmin))]
