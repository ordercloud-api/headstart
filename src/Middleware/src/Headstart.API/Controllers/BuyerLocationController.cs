...
namespace Headstart.API.Controllers
{
	...
	public class BuyerLocationController : CatalystController
	{
		...
		/// <returns>The ListPage of HSUser objects for a specific location as a buyer, ensures user has access to location orders, by buyerId and buyerLocationId</returns>
		...
		/// <param name="buyerId"></param>
		/// <param name="userId"></param>
		/// <returns>The ListPage of HSLocationUserGroup objects for home country</returns>
		...
		/// <returns>The ListPage of HSLocationUserGroup objects for new user</returns>
