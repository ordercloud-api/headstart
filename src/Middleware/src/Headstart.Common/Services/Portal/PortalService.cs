...
namespace Headstart.Common.Services
{
	...
	public class PortalService : IPortalService
	{
		...
		public PortalService(AppSettings settings, IFlurlClientFactory flurlFactory)
		{
			...
			{
				LogExt.LogException(_settings.LogSettings, Sitecore.Foundation.SitecoreExtensions.Extensions.Helpers.GetMethodName(), $@"{LoggingNotifications.GetGeneralLogMessagePrefixKey()}", ex.Message, ex.StackTrace, this, true);
			}
		}
