namespace Common.Services
{
    ...
    namespace NProg
    {
        public class Tracker
        {
            ...
            public void On(Trigger trigger, Action<Progress> action)
            {
            ...
            public void On(Trigger trigger, Func<Progress, Task> action)
            {
            ...
            {
                List<ProgressAction> fired = new List<ProgressAction>();
                Progress prog;
                ...
                lock (_lock)
                {
                    ...
                    foreach (ProgressAction act in fired)
                    {
                        if (!act.Recurring)
                        {
                            _actions.Remove(act);
            ...
            private abstract class ActionBase
            {
                ...
                {
                    Task task = AsyncAction?.Invoke(prog);
                    Action?.Invoke(prog);
